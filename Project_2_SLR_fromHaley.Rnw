...
Fires <- read_excel("~/Pomona Senior Year/Linear Models/Forestfires_forR.xlsx", sheet=1)
...
Fires <- read_excel("~/Pomona Senior Year/Linear Models/Forestfires_forR.xlsx", sheet=2)
